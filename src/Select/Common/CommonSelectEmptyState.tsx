...
function CommonSelectEmptyState(props: SelectEmptyStateProps) {
  return (
    <div
      className={cn("flex w-full flex-col items-center justify-center p-8", {
        "p-2 text-center": props.variant === "small",
      })}>
...
CommonSelectEmptyState.displayName = "CommonSelectEmptyState"

export { CommonSelectEmptyState }
