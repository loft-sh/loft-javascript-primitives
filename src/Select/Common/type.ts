...
export namespace CommonSelectStyles {
  export const TRIGGER = cn(
    "ring-offset-background placeholder:text-muted-foreground focus:ring-ring shadow-sm group flex w-full items-center",
    "justify-between whitespace-nowrap rounded-md border border-divider-main bg-transparent px-3 py-2 text-sm",
    "outline-none transition-all hover:cursor-pointer hover:border-primary-main focus:border-primary-main",
    "disabled:cursor-not-allowed disabled:opacity-50 data-[state=open]:text-disabledColor-dark [&>span]:line-clamp-1"
  )
