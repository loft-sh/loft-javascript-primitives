...
export namespace CommonSelectStyles {
  export const TRIGGER = cn(
    "bg-white ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring shadow-sm group flex w-full items-center",
    "justify-between whitespace-nowrap rounded-md border border-divider-main px-3 py-2 text-sm",
    "outline-none transition-all hover:cursor-pointer hover:border-primary-main focus-visible:border-primary-main",
