...
>(
  (
    ...
    if (!isInputVisible) {
      return (
        <div
          data-input-visible={isInputVisible}
          className={cn("w-full border-t border-divider-main px-1", containerClassName)}>
          <Button
            ref={buttonRef}
            type="button"
            onClick={handleClick}
            variant="ghost"
            className={cn("w-full justify-start pl-2 pt-[6px]", triggerClassName)}
            aria-expanded="false"
    ...
    return (
      <div
        ...
        data-input-visible={isInputVisible}
        className={cn(
          "w-full border-t border-divider-main py-1 pl-2 pr-2 pt-[6px]",
          containerClassName
        )}>
