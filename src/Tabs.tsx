...
>(({ className, size = "default", variant = "ghost", ...props }, ref) => (
  <TabsPrimitive.List
    ...
    data-size={size}
    className={cn(
      "scrollbar-hide group inline-flex min-h-9 items-center gap-4 overflow-x-auto rounded-lg p-1",
      {
  ...
  (
    ...
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        {
          // filled variant
          "group-[[data-variant]:not([data-variant=filled])]:mb-[-1px] data-[state=active]:z-10 group-data-[variant=filled]:rounded-t-lg group-data-[variant=filled]:border group-data-[variant=filled]:border-b-0 group-data-[variant=filled]:border-divider-light group-data-[variant=filled]:px-4 group-data-[variant=filled]:data-active:bg-white group-data-[variant=filled]:data-active:text-primaryColor-main group-data-[variant=filled]:data-inactive:bg-body-main group-data-[variant=filled]:data-inactive:text-secondary":
            true,
        },
        className
      )}
