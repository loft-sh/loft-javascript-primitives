...
>((props, ref) => {
  return <DropdownMenuPrimitive.Trigger ref={ref} role={"button"} {...props} />
})
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-pointer select-none items-center gap-2 px-3 py-2 text-secondary outline-none transition-colors hover:bg-neutral-extra-light focus-visible:bg-neutral-extra-light",
      {
