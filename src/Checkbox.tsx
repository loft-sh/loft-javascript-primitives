    ...
    return (
      <MaybeWrapper hasLabel={!!children}>
        <CheckboxPrimitive.Root
          ...
          ref={ref}
          className={cx(
            "group peer h-4 w-4 shrink-0 rounded-sm border border-neutral-main bg-white ring-offset-background-light-40 transition-colors duration-200 ease-out enabled:text-white disabled:cursor-not-allowed disabled:opacity-50 aria-[checked=true]:bg-neutral-dark",
            "hover:border-danger-main disabled:hover:bg-none",
            "cursor-pointer hover:border-neutral-dark focus:border-neutral-dark focus-visible:outline-none  focus-visible:ring-2 focus-visible:ring-neutral-light focus-visible:ring-offset-2 focus-visible:ring-offset-white",
