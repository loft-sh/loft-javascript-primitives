...
export function getButtonClasses({
  ...
  return cn(
    "ring-offset-background group inline-flex cursor-pointer select-none items-center justify-center gap-2 whitespace-nowrap rounded border font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-2 disabled:pointer-events-none data-[loading=true]:pointer-events-none magic-[disabled,data-[loading=true]]:opacity-60",
    {
      ...
      "bg-brand-main border-brand-dark text-brand-contrast hover:bg-brand-mid-light hover:border-brand-main active:border-brand-main focus-visible:border-brand-main focus-visible:bg-brand-mid-light active:bg-brand-dark data-[loading=true]:bg-brand-light":
      ...
      "text-neutral-dark hover:bg-neutral-extra-light hover:text-neutral-mid-light focus-visible:bg-neutral-extra-light active:bg-neutral-light active:text-neutral-dark":
      ...
      "border border-neutral-light text-primary hover:bg-neutral-extra-light hover:text-secondary focus-visible:text-neutral-main active:border-neutral-dark active:text-neutral-dark disabled:text-primary data-[loading=true]:text-primary":
    ...
    return (
      <Comp
        ...
        {(loading || isLoading) && (
          <Loading
            className="w-fit"
            spinnerClassName={"size-4 ![color:inherit]"}
            variant={"pronounced"}
          />
        )}
        {props.children}
