      ...
      <Comp
        ...
        className={cn(
          "ring-offset-background group inline-flex cursor-pointer select-none items-center justify-center gap-2 whitespace-nowrap rounded border font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-2 disabled:pointer-events-none data-[loading=true]:pointer-events-none magic-[disabled,data-[loading=true]]:opacity-60",
          {
            ...
            "bg-primary-main hover:bg-primary-light focus-visible:bg-primary-light active:bg-primary-dark data-[loading=true]:bg-primary-light":
            ...
            "bg-danger-main  hover:bg-danger-light focus-visible:bg-danger-light active:bg-danger-dark disabled:bg-danger-light data-[loading=true]:bg-danger-light":
              appearance === "danger" && variant === "filled",

            "border border-danger-main bg-transparent text-danger-main hover:border-danger-light hover:text-danger-light focus-visible:text-danger-light active:border-danger-dark active:text-danger-dark disabled:border-danger-light data-[loading=true]:border-danger-light":
            ...
            "text-neutral-dark hover:bg-neutral-extra-light focus-visible:bg-neutral-extra-light active:bg-neutral-light active:text-neutral-dark magic-[disabled,data-[loading=true]]:border magic-[disabled,data-[loading=true]]:border-neutral-main":
            ...
            "bg-success-main hover:bg-success-light focus-visible:bg-success-light active:bg-success-dark disabled:bg-success-light data-[loading=true]:bg-success-light":
              appearance === "success" && variant === "filled",

            "border border-success-main bg-transparent text-success-main hover:border-success-light hover:text-success-light focus-visible:text-success-light active:border-success-dark active:text-success-dark disabled:border-success-light data-[loading=true]:border-success-light":
              appearance === "success" && variant === "outlined",

            "bg-warning-main hover:bg-warning-light focus-visible:bg-warning-light active:bg-warning-dark disabled:bg-warning-light data-[loading=true]:bg-warning-light":
              appearance === "warning" && variant === "filled",

            "border border-warning-main bg-transparent text-warning-main hover:border-warning-light hover:text-warning-light focus-visible:text-warning-light active:border-warning-dark active:text-warning-dark disabled:border-warning-light data-[loading=true]:border-warning-light":
              appearance === "warning" && variant === "outlined",
            "bg-neutral-main text-white hover:bg-neutral-light focus-visible:bg-neutral-light active:bg-neutral-dark disabled:bg-neutral-main data-[loading=true]:bg-neutral-main":
              appearance === "neutral" && variant === "filled",

            "border   border-neutral-light text-primary hover:text-secondary focus-visible:text-neutral-main active:border-neutral-dark active:text-neutral-dark disabled:text-primary data-[loading=true]:text-primary":
              appearance === "neutral" && variant === "outlined",

            "bg-transparent text-primary hover:bg-neutral-extra-light focus-visible:bg-neutral-extra-light active:bg-neutral-light active:text-primary":
              appearance === "primary" && variant === "unstyled",

            "px-0 py-0 hover:bg-transparent focus-visible:bg-transparent active:bg-transparent":
              clipped,
          },
          className
        )}
