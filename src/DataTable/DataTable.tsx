...
export function DataTable<TData>({
  ...
  const emptyStateWidth = useMeasureElementWidth(tableRef)
            ...
            {shouldShowSkeleton ? (
              ...
              <TableRow>
                <TableCell
                  ...
                  {isEmpty ? (
                    <div style={{ maxWidth: emptyStateWidth }} className="px-4">
                      {emptyState || (
                  ...
                  {hasFilteredResults && (
                    <TableNoFilterResults maxWidth={emptyStateWidth} table={table} />
                  )}
                </TableCell>
              </TableRow>
            )}
