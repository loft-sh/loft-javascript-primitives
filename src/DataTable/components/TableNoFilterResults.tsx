...
export function TableNoFilterResults<TData>({ table, maxWidth }: Props<TData>) {
  ...
  return (
    <div style={{ maxWidth }} className="flex flex-col items-center justify-center gap-2 px-4 py-6">
