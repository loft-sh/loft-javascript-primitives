...
export const ActionsContainer = ({ children, className }: ActionsContainerProps) => {
  const rowContext = useContext(DataTableRowContext) as TableRowContextOptions | undefined
...
export const ActionDropdown = ({
  ...
  const rowContext = useContext(DataTableRowContext) as TableRowContextOptions | undefined
  const setActionMenuOpen = rowContext?.setActionMenuOpen
