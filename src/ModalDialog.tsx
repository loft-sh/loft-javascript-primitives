...
function ModalBody({ children, className }: { children?: React.ReactNode; className?: string }) {
  return (
    <div
      className={cn("flex w-full flex-col px-6 py-2 text-sm font-normal text-primary", className)}>
      {children}
    </div>
  )
}
    ...
    <>
      {leftAction && (
        <Button
          ...
          {leftAction.Icon ? <leftAction.Icon /> : leftAction.icon} {leftAction.label}
        </Button>
      )}
      <div className={"ml-auto flex flex-row items-center gap-2"}>
        {secondaryAction && (
          <Button
            ...
            {secondaryAction.Icon ? <secondaryAction.Icon /> : secondaryAction.icon}{" "}
        ...
        {primaryAction && (
          <Button
            ...
            {primaryAction.Icon ? <primaryAction.Icon /> : primaryAction.icon} {primaryAction.label}
          </Button>
        )}
      </div>
    </>
