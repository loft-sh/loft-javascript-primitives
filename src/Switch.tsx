    ...
    return (
      <div
        ...
        <SwitchPrimitives.Root
          ...
          className={cx(
            `focus-visible:ring-ring focus-visible:ring-offset-background group/switch peer relative inline-flex shrink-0 cursor-pointer items-center rounded-full border border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2  focus-visible:ring-offset-2 disabled:cursor-not-allowed`,
            {
              "aria-[checked=false]:bg-neutral-mid-light": !props.disabled,
              "disabled:border-disabled-main disabled:bg-none": props.disabled,
              "h-6 w-11": size === "default",
              "h-4 w-7": size === "small",
              "aria-[checked=false]:bg-disabled-main aria-[checked=true]:bg-neutral-mid-light":
                loading,
              "aria-[checked=true]:bg-neutral-dark": !loading && !props.disabled,
            },
            className
          )}
          {...props}
          ...
          <SwitchPrimitives.Thumb
            className={cx(
              "pointer-events-none relative block rounded-full ring-0 transition-transform group-active/switch:scale-x-125 group-active/switch:delay-75",
              ...
              {
                "bg-neutral-contrast": !props.disabled,
                "bg-disabled-main": props.disabled,
