...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "cursor-pointer border-x-0 border-b border-t-0 border-divider-main bg-table-header p-2 px-4 text-left text-xs font-semibold text-secondary transition-colors hover:bg-table-header-hover",
      className
    )}
    {...props}
  />
...
>(({ className, variant = "default", ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "border-x-0 border-b border-t-0  border-b-divider-main bg-table-cell px-4 py-2.5 align-middle text-primary transition-opacity group-hover:bg-table-cell-hover group-data-[state=selected]:bg-table-cell-hover",
      {
