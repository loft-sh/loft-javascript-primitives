...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-top-level bg-gray-100/60 data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
    ...
    return (
      <SheetPortal>
        ...
        <SheetPrimitive.Content
          ref={ref}
          className={cn(
            "fixed z-top-level h-full min-w-[650px] gap-4 shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-300 data-[state=open]:duration-200",
            "flex flex-col",
          ...
          <div className={cn("flex-1 overflow-auto", wrapperClassName)}>
            <div className="flex h-full w-full flex-col overflow-x-auto [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:whitespace-pre">
              {children}
            </div>
          </div>
        </SheetPrimitive.Content>
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("mb-0 text-lg font-semibold", className)}
    {...props}
  />
))
