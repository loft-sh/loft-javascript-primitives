  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}>
        <div className={cn("flex flex-1 flex-col overflow-auto", wrapperClassName)}>
          <div className="flex flex-1 flex-col overflow-auto [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:whitespace-pre">
            {children}
          </div>
        </div>
      </SheetPrimitive.Content>
