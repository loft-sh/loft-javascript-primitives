...
export type ExpansionsListInstance = {
...
export const ExpansionsList = forwardRef(function ExpansionsList(
  { className, children }: ExpansionsListProps,
  ref: ForwardedRef<ExpansionsListInstance>
) {
  const [openItem, setOpenItem] = useState<string | null>(null)

  useImperativeHandle(ref, () => ({ setOpenItem }), [setOpenItem])
...
ExpansionsList.displayName = "ExpansionsList"

export function ExpansionsListItem({ className, children, ...props }: ExpansionsListItemProps) {
  const id = useId()
