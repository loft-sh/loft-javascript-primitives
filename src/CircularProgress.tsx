        ...
        <svg width={size} height={size} className="-rotate-90 transform">
          <defs>
            <linearGradient
              ...
              x2={size}
              y2={size}>
              <stop offset="0%" stopColor={BG_COLORS[variant]} stopOpacity="0.15" />
              <stop offset="25%" stopColor={BG_COLORS[variant]} stopOpacity="0.4" />
              <stop offset="50%" stopColor={BG_COLORS[variant]} stopOpacity="0.15" />
              <stop offset="75%" stopColor={BG_COLORS[variant]} stopOpacity="0.4" />
              <stop offset="100%" stopColor={BG_COLORS[variant]} stopOpacity="0.15" />
            </linearGradient>
          </defs>
