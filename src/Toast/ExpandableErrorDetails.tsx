  ...
  return (
    <div ref={containerRef} className="flex flex-col gap-2">
      <div
        ...
        className={
          needsExpansion && !expanded ? "overflow-hidden" : expanded ? "overflow-auto" : undefined
        }>
        <div ref={contentRef} onPointerDown={(e) => e.stopPropagation()}>
          <pre className="mb-0 cursor-text select-text whitespace-pre-wrap break-all text-sm">
            {errMessage}
          </pre>
        </div>
      </div>
